...
class PayloadBuilderService
{
    ...
    /**
     * Baut EIN Sendungsobjekt aus allen Mitgliedern einer Familie.
     * Alle Lieferaufträge einer Familie = eine Sendung mit allen
     * Positionen zusammengefasst unter der Parent-Auftragsnummer.
     */
    private function buildFamilyShippingObject(array $familyShipments, string $pickupDate, int $familyId): array
    {
        $first = $familyShipments[0];
